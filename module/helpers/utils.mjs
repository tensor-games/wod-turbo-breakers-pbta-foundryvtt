...
export const preloadHandlebarsTemplates = async function () {
    return loadTemplates([
      ...
      'modules/wod-turbo-breakers-pbta-foundryvtt/templates/parts/actor-stats.hbs',
      'modules/wod-turbo-breakers-pbta-foundryvtt/templates/parts/actor-description.hbs',
